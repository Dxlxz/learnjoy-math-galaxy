...
import { Trophy, Book, GamepadIcon, Map, Crown, Loader, ScrollText, BarChart, Eye } from 'lucide-react';
...
const HeroProfile = () => {
  ...
  const [isParentView, setIsParentView] = React.useState(false);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-[#FDF6E3] to-[#FEFCF7]">
        <div className="text-center space-y-4">
          ...
          <h2 className="text-2xl font-bold text-[#2D3748] animate-pulse">
            {isParentView ? "Loading progress report..." : "Loading your hero profile..."}
          </h2>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-gradient-to-br from-[#9b87f5] via-[#7E69AB] to-[#6E59A5] p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto space-y-6 relative z-10">
        <div className="flex justify-between items-center">
          <Card className="border-2 border-[#FFC107]/20 bg-white/90 backdrop-blur-sm p-4 flex items-center gap-4">
            ...
            <Switch
              ...
              onCheckedChange={setIsParentView}
          ...
          <CardHeader className="text-center">
            <CardTitle className="text-3xl md:text-4xl font-bold text-[#2D3748] flex items-center justify-center gap-3">
              ...
              <span className="bg-gradient-to-r from-[#FFA000] to-[#FFC107] bg-clip-text text-transparent">
                {isParentView ? `Learning Progress: ${profile?.hero_name}` : `${profile?.hero_name}'s Quest Command Center`}
              </span>
            </CardTitle>
          </CardHeader>
          <CardContent className="grid md:grid-cols-3 gap-4 p-6">
            <div className="text-center space-y-2 transform hover:scale-105 transition-transform duration-300">
              ...
              <h3 className="font-semibold text-[#4A5568]">
                {isParentView ? "Completed Lessons" : "Quests Completed"}
              </h3>
            ...
            <div className="text-center space-y-2 transform hover:scale-105 transition-transform duration-300">
              <BarChart className="h-8 w-8 mx-auto text-[#4CAF50] animate-float" />
              <h3 className="font-semibold text-[#4A5568]">
                {isParentView ? "Average Performance" : "Average Score"}
              </h3>
        ...
        <Card className="border-2 border-[#1976D2]/20 bg-white/90 backdrop-blur-sm animate-fade-in hover:shadow-lg hover:shadow-[#1976D2]/10 transition-all duration-300">
          <CardHeader>
            <CardTitle className="text-xl font-semibold text-[#2D3748] flex items-center gap-2">
              ...
              {isParentView ? "Recent Learning Activities" : "Recent Adventures"}
            </CardTitle>
          </CardHeader>
              ...
              >
                ...
                <div className="ml-4 flex flex-col items-center justify-center">
                  ...
                  <span className="text-xs font-medium mt-1 text-[#4A5568]">
                    {topic.score >= 90 ? (isParentView ? 'Outstanding!' : 'Perfect!') : 'Great Effort!'}
                  </span>
                </div>
              </div>
            ))}
