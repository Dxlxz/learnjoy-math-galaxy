        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <FeatureItem
                icon={MapPin}
                title="Explore Math Topics"
                description="Navigate through engaging lessons and challenges"
              />
              <FeatureItem
                icon={Calculator}
                title="Interactive Practice"
                description="Learn by doing with fun, hands-on exercises"
              />
              <FeatureItem
                icon={Book}
                title="Track Progress"
                description="See your achievements and learning journey"
              />
            </div>
            <div className="space-y-4 pt-4">
              <Button
                onClick={startGuestAdventure}
                className="w-full bg-primary-600 hover:bg-primary-700 group"
                disabled={loading}
              >
                {loading ? (
          ...
          <div className="hidden md:flex items-center justify-center">
            <div className="relative w-full max-w-sm">
              ...
              <img
                ...
                alt="Math Explorer Mascot"
                className="relative w-full h-auto animate-bounce-slow"
              />
            </div>
          </div>
        </div>
